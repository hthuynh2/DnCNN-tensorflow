...
parser.add_argument('--lr', dest='lr', type=float, default=0.009, help='initial learning rate for adam')
...
def denoiser_test(denoiser):
    denoiser.predict(ckpt_dir=args.ckpt_dir, save_dir=args.test_dir)
